...
public static class StaticStrings
{
	...
	public const string FailedToModifyOrDeleteNoOrderBookMessage     = "Failed to delete order, OrderBook does not exist";
	public const string FailedToModifyOrDeleteOrderIdNonExistent     = "Failed to delete order, OrderId does not exist";
